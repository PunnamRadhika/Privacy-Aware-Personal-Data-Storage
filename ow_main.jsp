...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to PDS Owner Main : <span class="style3"><%=application.getAttribute("ow")%></span></h2>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style4">
            ...
            <li><a href="ow_access_control_per.jsp">Set Access Control Permission</a></li>
            <li><a href="ow_patient_det.jsp">View All Uploaded Patient Details </a></li>
            <li><a href="ow_acc_con_det.jsp">View All Access Control Provided Details </a></li>
            <li><a href="owner_login.jsp">Log Out</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
