    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li class="style4"><a href="au_all_owners.jsp">View All PDS Owners and Authorize</a></li>
            <li><strong><a href="au_all_users.jsp">View All Users and Authorize</a></strong></li>
            <li><strong><a href="au_sk_req.jsp">View All SK Requests and Permit</a></strong></li>
            <li><strong><a href="au_all_attacker.jsp"> View All Credential Attackers Details </a></strong></li>
			
			 <li><strong><a href="au_all_Inference_attackers.jsp"> View All External Attackers Details </a></strong></li>
