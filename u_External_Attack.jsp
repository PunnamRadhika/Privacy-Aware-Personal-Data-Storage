    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="user_login.jsp"><span>Attacker</span></a></li>
...
<form name="s" action="u_External_Attack.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
...
try
{
			   ...
			   <form name="s" action="Attack.jsp" method="post" >   
               <div align="center" class="style3 style11"><strong>Patient Name : <span class="style15"> <%=s2%></span></strong></div>
               <span class="style6"><br />
               </span>
               <div align="center" class="style3 style11"><strong>Disease Name :  <span class="style15"><textarea> <%=decryptedValues3%></textarea></span></strong></div>
			   <div align="center">
			     <INPUT name="submit" TYPE="submit" STYLE="width:50px; height:25px;" VALUE="Attack"/>
			     </div>
			   </form>
               </p>
