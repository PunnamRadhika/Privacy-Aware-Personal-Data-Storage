...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">  Profession Log In!!!</h2>
		  
		  <form name="s" action="u_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">
		    <div align="center">
    <table border="0" width="65%" height="165">
      <tr>
        <td height="25" colspan="2"><div align="center"><img src="images/Login.jpg" width="244" height="124" /></div></td>
        </tr>
      <tr>
    ...
    <p>New User?  <a href="u_register.jsp">click here to Register</a><br />
    </p>
    </div>
</form>
