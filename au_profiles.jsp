...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1 style2">Inference Attack-Resistant E-Healthcare Cloud System<br />
        </a><a href="index.html" class="style1 style2">with Fine-Grained Access Control</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
