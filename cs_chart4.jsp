...
<head>
<title>Patients Attacked Rank Chart</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">View No.Of Attackers on Patient Accessing by Wrong Secret Key</h2>
          <p align="center">&nbsp;</p>
		  ...
		  <p> 
	      <iframe align="middle" width="555" height="400" src="graph4.jsp"></iframe></p>
          ...
          <p align="center"><a href="cs_all_attacker.jsp" class="style14">Back</a></p>
	    </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
